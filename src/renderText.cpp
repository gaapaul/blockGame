...
void textRender::init() {
  ...
  this->textShader.compile(this->vertexShaderSource,
                           this->fragmentShaderSource);
  this->textShader.Use();
  this->textShader.SetMatrix4(
      "projection",
      glm::ortho(1.0f, static_cast<float>(1), static_cast<float>(1), 1.0f),
      true);
  ...
  if (FT_New_Face(this->ft, "/usr/share/fonts/truetype/ubuntu/Ubuntu-B.ttf", 0,
                  &this->face)) {
...
void textRender::renderText(std::string text, glm::vec2 position,
