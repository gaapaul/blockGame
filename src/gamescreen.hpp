...
#include <glm.hpp>
#include <vector>
// Game screen contains info for the game board and where pieces are stored for
// collision detection and to clear lines
class gamescreen {
private:
...
public:
  ...
  int board_size_x = 12;
  int board_size_y = 22;
  enum GAMESTATE { ACTIVE, GAMEOVER, PAUSE };
  tile *backgroundTile;
